...
class ANETcaptions(object):
    ...
    def evaluate(self):
        ...
        for tiou in self.tious:
            ...
            self.scores['detc_Recall'].append(recall)
            self.scores['detc_Precision'].append(precision)
    ...
    def evaluate_tiou(self, tiou):
        ...
        for scorer, method in self.scorers:
            ...
            tokenize_res = {index:[cur_res[index][0]['caption']] for index in cur_res}
            tokenize_gts = {index:[cur_gts[index][0]['caption']] for index in cur_gts}
